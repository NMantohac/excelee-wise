    ...
    <div style={{ height: '130px' }}>
      <Navbar bg="light" expand="lg" sticky="top" className="navbar">
        ...
        <Navbar.Brand as={Link} to="/" style={{ marginLeft: '5px' }}>
          <Fade right>
            <Image src="https://res.cloudinary.com/trizept/image/upload/v1594423092/rsz_navbar-brand_f4at8l_50e6a62eae5be367f7a904bdeacc154b_srmsyl-min_gkj32j.png" fluid alt="PHPLA Brand Logo" className="d-inline-block align-top logo navbar-logo" />
          </Fade>
        </Navbar.Brand>
