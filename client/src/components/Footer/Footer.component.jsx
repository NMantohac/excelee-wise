      ...
      <MDBContainer fluid className="text-center text-md-left">
        <MDBRow className="align-items-center">
          <MDBCol md="6" lg="7" xl="7">
            <Image src="https://res.cloudinary.com/trizept/image/upload/v1594410102/footer-logo_gcdoxe.png" height="100" width="300" fluid alt="Footer Logo" className="d-inline-block align-top logo" />
