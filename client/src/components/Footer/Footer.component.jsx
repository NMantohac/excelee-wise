      ...
      <MDBContainer fluid className="text-center text-md-left">
        <MDBRow className="align-items-center">
          <MDBCol md="6" lg="7" xl="7">
            <Image src="https://res.cloudinary.com/trizept/image/upload/v1594419683/rsz_footer-logo_gcdoxe_5f7a81b06ed16ddcc1e338e32a73352c_nkjrbl.png" height="100" width="300" fluid alt="Footer Logo" className="d-inline-block align-top logo" />
