    ...
    <div>
      <Container style={{ fontFamily: 'Amatic SC, serif', textAlign: 'center' }}>
        ...
        <Row style={{ marginBottom: '30px' }}>
          ...
          <Col xs={{ span: 12, order: 1 }} sm={{ span: 12, order: 1 }} md={{ span: 6, order: 12 }} lg={{ span: 6, order: 12 }} xl={{ span: 6, order: 12 }}>
            <ModalImage small="https://res.cloudinary.com/trizept/image/upload/v1594410100/bg-4_pj21gx.jpg" large="https://res.cloudinary.com/trizept/image/upload/v1594410100/bg-4_pj21gx.jpg" showRotate="true" />
          </Col>
        </Row>
        <Row style={{ marginBottom: '30px' }}>
          <Col xs={12} sm={12} md={6} lg={6} xl={6}>
            <ModalImage small="https://res.cloudinary.com/trizept/image/upload/v1594410100/bg-5_kyfu1r.jpg" large="https://res.cloudinary.com/trizept/image/upload/v1594410100/bg-5_kyfu1r.jpg" showRotate="true" />
          </Col>
          <Col xs={12} sm={12} md={6} lg={6} xl={6} className="home-text-col">
            <Slide right>
